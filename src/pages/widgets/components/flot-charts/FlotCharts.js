          ...
          >
            <div className="chart-stats">
              <p className="text-light fs-mini mt-xs">
                ...
                <span className="fw-semi-bold">Jess:</span> Seems like
                statically it&apos;s getting impossible to achieve any sort of
                results in nearest future. The only thing we can hope for is
            ...
            title={
              <Row>
                <Col xs={12}>
                  ...
                  <span className="text-light fs-mini">
                    monthly report will be available in{' '}
                    <button className="btn-link">6 hours</button>
                  </span>
                </Col>
              </Row>
            }
              ...
              <div className="row">
                <div className="col-md-5">
                  <div className="clearfix m-t-1">
                    <h6 className="pull-left text-light mb-xs">Income</h6>
                    <p className="pull-right h6 mb-xs">
                      <span className="fw-semi-bold">$14,595</span>
                    </p>
                  </div>
                  <div className="clearfix">
                    <h6 className="pull-left no-margin text-light">Recent</h6>
