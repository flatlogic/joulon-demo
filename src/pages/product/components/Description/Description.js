                  ...
                  <button className="accordion-toggle">
                    ...
                    <i
                      className={`fa fa-angle-down fa-2x ${
                        this.state.accordion[0] ? 'expanded' : ''
                      }`}
                    />
                  </button>
                </div>
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    ...
                    <i
                      className={`fa fa-angle-down fa-2x ${
                        this.state.accordion[1] ? 'expanded' : ''
                      }`}
                    />
                  </button>
                </div>
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    ...
                    <i
                      className={`fa fa-angle-down fa-2x ${
                        this.state.accordion[2] ? 'expanded' : ''
                      }`}
                    />
                  </button>
                </div>
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    ...
                    <i
                      className={`fa fa-angle-down fa-2x ${
                        this.state.accordion[3] ? 'expanded' : ''
                      }`}
                    />
                  </button>
                </div>
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    ...
                    <i
                      className={`fa fa-angle-down fa-2x ${
                        this.state.accordion[4] ? 'expanded' : ''
                      }`}
                    />
                  </button>
                </div>
