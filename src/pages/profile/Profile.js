        ...
        <Widget>
          ...
          <Row>
            ...
            <Col md={7} xs={12}>
              ...
              <p>
                <button className="btn-link badge badge-warning rounded-0">
                  {' '}
                  UI/UX{' '}
                </button>
                <button className="btn-link badge badge-danger rounded-0 ml-2">
                  {' '}
                  Web Design{' '}
                </button>
                <button className="btn-link badge badge-default rounded-0 ml-2">
                  {' '}
                  Mobile Apps{' '}
                </button>
              </p>
              <p className="lead mt-xlg">
                My name is Adam Johns and here is my new Light Blue user profile
                page.
              </p>
