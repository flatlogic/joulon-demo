    ...
    return (
      <div>
        <h2 className="page-title">
          Light Blue - <span className="fw-semi-bold">Package</span>&nbsp;
        ...
        <Row>
          <Col lg={5} md={6}>
            <Widget title={<h6>React JS Version</h6>} settings collapse close>
              <img
                className={['pull-left mb-1 mr-3', s.image].join(' ')}
                src={reactLogo}
                width="80"
                alt=""
              />
              ...
              <button className="btn btn-transparent btn-lg btn-block disabled">
                (You are here)
              </button>
            </Widget>
          </Col>
