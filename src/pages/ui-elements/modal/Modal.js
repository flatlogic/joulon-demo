    ...
    return (
      <div>
        ...
        <Modal isOpen={demo} toggle={() => this.toggle('demo')}>
          ...
          <ModalFooter>
            <Button color="dark" onClick={() => this.toggle('demo')}>
              Close
            </Button>
        ...
        >
          ...
          <ModalFooter>
            <Button color="dark" onClick={() => this.toggle('scrollingLong')}>
              Close
            </Button>
            <Button color="primary">Save changes</Button>
          </ModalFooter>
        ...
        <Modal size="lg" isOpen={large} toggle={() => this.toggle('large')}>
          ...
          <ModalFooter>
            <Button color="dark" onClick={() => this.toggle('large')}>
              Close
            </Button>
            <Button color="primary">Save changes</Button>
          </ModalFooter>
        ...
        <Modal size="sm" isOpen={small} toggle={() => this.toggle('small')}>
          ...
          <ModalFooter>
            <Button color="dark" onClick={() => this.toggle('small')}>
              Close
            </Button>
            <Button color="primary">Save changes</Button>
          </ModalFooter>
        ...
        <Modal isOpen={launch} toggle={() => this.toggle('launch')}>
          ...
          <ModalFooter>
            <Button color="dark" onClick={() => this.toggle('launch')}>
              Close
            </Button>
            <Button color="primary">Save changes</Button>
          </ModalFooter>
