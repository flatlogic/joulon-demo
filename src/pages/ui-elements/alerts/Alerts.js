  ...
  state = {
    alerts: [
      ...
      },
      {
        ...
        type: 'warning',
        msg:
          '<span class="fw-semi-bold"><strong>Warning:</strong></span> Best check yo self, you\'re not looking too good.',
        visible: [true, true, true],
      },
      {
        id: 'al-4',
        type: 'danger',
        msg:
          '<span class="fw-semi-bold">Danger:</span> Change this and that and try again. <a class="btn btn-default btn-xs float-right mr" href="#">Ignore</a> <a class="btn btn-danger btn-xs float-right mr-xs" href="#">Take this action</a>',
        visible: [true, true, true],
      },
    ],
  };
        ...
        <Row>
          <Col xs={12} md={8}>
            <Widget
              title={
                <h5>
                  Alert <span className="fw-semi-bold">Messages</span>
                </h5>
              }
              close
              collapse
          ...
          <Col xs={12} md={8}>
            <Widget
              title={
                <h5>
                  Transparent <span className="fw-semi-bold">Alerts</span>
                </h5>
              }
              close
              collapse
          ...
          <Col xs={12} md={8}>
            <Widget
              title={
                <h5>
                  Rounded <span className="fw-semi-bold">Alerts</span>
                </h5>
              }
              close
              collapse
          ...
          <Col xs={12} md={8}>
            <Widget
              title={
                <h5>
                  Additional <span className="fw-semi-bold">Content</span>
                </h5>
              }
              close
              collapse
