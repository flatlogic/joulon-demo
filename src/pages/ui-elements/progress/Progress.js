...
import { Row, Col, Breadcrumb, BreadcrumbItem, Progress } from 'reactstrap';
    ...
    <Row>
      <Col xs={12} md={6}>
        <Widget
          title={
            <h5>
              Progress <span className="fw-semi-bold">Example</span>
            </h5>
          }
          close
          collapse
      ...
      <Col xs={12} md={6}>
        <Widget title={<h5>Backgrounds</h5>} close collaple>
          <p>
      ...
      <Col xs={12} md={6}>
        <Widget title={<h5>Labels</h5>} close collapse>
          <p>
      ...
      <Col xs={12} md={6}>
        <Widget title={<h5>Size</h5>} close collapse>
          <p>
          ...
          <Progress className="progress-sm mb-sm" value="25" color="dark">
            25%
          </Progress>
          <Progress className="mb-sm" value="50" color="gray">
            50%
          </Progress>
          <Progress value="75" color="secondary" style={{ height: '30px' }}>
            75%
          </Progress>
        </Widget>
      </Col>
      <Col xs={12}>
        <Widget
          title={
            <h5>
              <span className="fw-semi-bold">Striped</span> Progress
            </h5>
          }
          close
          collapse
