        ...
        <Row>
          <Col xs={12} md={6}>
            <Widget
              ...
              title={
                <h5>
                  Popover <span className="fw-semi-bold">Example</span>
                </h5>
              }
              close
              collapse
            ...
            <Widget
              title={
                <h5>
                  Popover <span className="fw-semi-bold">Directions</span>
                </h5>
              }
              close
              collapse
          ...
          <Col xs={12} md={6}>
            <Widget
              ...
              title={
                <h5>
                  Tooltip <span className="fw-semi-bold">Example</span>
                </h5>
              }
              close
              collapse
            >
              <Button id="t-1" className="mr-sm" size="lg" color="success">
                Tooltip
              </Button>
            ...
            <Widget
              title={
                <h5>
                  Tooltip <span className="fw-semi-bold">Directions</span>
                </h5>
              }
              close
              collapse
            >
              <Button id="t-3" className="mr-xs mb-xs" color="info">
                Tooltip on top
              </Button>
              <Button id="t-4" className="mr-xs mb-xs" color="warning">
                Tooltip on right
              </Button>
              <Button id="t-5" className="mr-xs mb-xs" color="inverse">
                Tooltip on bottom
              </Button>
              <Button id="t-6" className="mr-xs mb-xs" color="default">
                Tooltip on left
              </Button>
            </Widget>
          </Col>
